      ...
      <div className="flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-10 md:gap-16 relative">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <div className="flex items-center gap-2">
            <Dot size={60} className="text-red-500 shrink-0" />
            <h4 className="text-lg md:text-xl font-semibold text-blue-950 tracking-wide">
              FORDX AT YOUR SERVICE
            </h4>
          </div>

          {/* Main Title */}
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-blue-950 leading-snug">
            We Provide{" "}
